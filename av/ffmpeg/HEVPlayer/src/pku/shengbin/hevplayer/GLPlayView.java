...
public class GLPlayView extends GLSurfaceView {
	...
	private void init(boolean translucent, int depth, int stencil) {
         ...
         */
        if (translucent) {
            this.getHolder().setFormat(PixelFormat.TRANSLUCENT);   //设置透明度
        }
        ...
        setRenderer(new GLRenderer());  //添加一个渲染器
        
        setRenderMode(GLSurfaceView.RENDERMODE_WHEN_DIRTY);  //渲染器模式。连续或间断式渲染
    }
